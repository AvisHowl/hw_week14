const directors = [
	...
	{
		name: "Виктор Шамиров",
		career: "Режиссер, Спецарист, Актер, Продюсер, Монтажер",
...
`;
	directorContainer.appendChild(directorElement);
});
...
const strTopFilmsList = topFilmsList.join(", ");
topFilmsContainer.textContent = strTopFilmsList;
